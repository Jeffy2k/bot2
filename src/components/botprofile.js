...
function BotProfile({deleteArmyItem,deleteWithoutRefresh,id,image,name,phrase,health,armor,damage,addBot,handleId}) {
 ...
 function deleteItem(){
  console.log('deleted')
  setAdded(false)
 fetch (`https://json-server2-vercel.vercel.app/bots/${id}`,{
  method : 'DELETE'})
